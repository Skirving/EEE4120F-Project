...
module GPR_tb;
    ...
    initial begin
        ...
        //
                   ...
                   reg_write_en = 1'b0;
                   #2;
                   check16(reg_read_data_1, 16'hABCD, test_id); test_id = test_id + 1;
